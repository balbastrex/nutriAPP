...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.durninWomersley.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.durnin-womersleys.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                @foreach(App\Models\DurninWomersley::EDAD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('edad') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="edad_{{ $key }}" name="edad" value="{{ $key }}" {{ old('edad', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biceps') ? 'is-invalid' : '' }}" type="text" name="biceps" id="biceps" value="{{ old('biceps', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('triceps') ? 'is-invalid' : '' }}" type="text" name="triceps" id="triceps" value="{{ old('triceps', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subescapular') ? 'is-invalid' : '' }}" type="text" name="subescapular" id="subescapular" value="{{ old('subescapular', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('suprailiaco') ? 'is-invalid' : '' }}" type="text" name="suprailiaco" id="suprailiaco" value="{{ old('suprailiaco', '') }}" required>
