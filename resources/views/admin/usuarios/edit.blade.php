...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.usuario.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.usuarios.update", [$usuario->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $usuario->nombre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apellidos') ? 'is-invalid' : '' }}" type="text" name="apellidos" id="apellidos" value="{{ old('apellidos', $usuario->apellidos) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_de_nacimiento') ? 'is-invalid' : '' }}" type="text" name="fecha_de_nacimiento" id="fecha_de_nacimiento" value="{{ old('fecha_de_nacimiento', $usuario->fecha_de_nacimiento) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dni') ? 'is-invalid' : '' }}" type="text" name="dni" id="dni" value="{{ old('dni', $usuario->dni) }}" required>
                @if($errors->has('dni'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dni') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $usuario->telefono) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direccion') ? 'is-invalid' : '' }}" type="text" name="direccion" id="direccion" value="{{ old('direccion', $usuario->direccion) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $usuario->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ocupacion') ? 'is-invalid' : '' }}" type="text" name="ocupacion" id="ocupacion" value="{{ old('ocupacion', $usuario->ocupacion) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('turno_laboral') ? 'is-invalid' : '' }}" type="text" name="turno_laboral" id="turno_laboral" value="{{ old('turno_laboral', $usuario->turno_laboral) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contacto') ? 'is-invalid' : '' }}" type="text" name="contacto" id="contacto" value="{{ old('contacto', $usuario->contacto) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('meta') ? 'is-invalid' : '' }}" name="meta_id" id="meta_id">
                    @foreach($metas as $id => $entry)
                        <option value="{{ $id }}" {{ (old('meta_id') ? old('meta_id') : $usuario->meta->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('meta'))
                    <div class="invalid-feedback">
